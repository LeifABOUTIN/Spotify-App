...
const Spotify = () => {
  ...
  const handleConnexion = () => {
    window.location.href = `https://accounts.spotify.com/authorize?client_id=${client_id}&response_type=code&redirect_uri=${myURL}&scope=user-read-recently-played user-library-read user-library-modify`
  }
  useEffect(() => {
    getToken()
  }, [])
  ...
  return (
    <div className="Spotify">
      <div className="nav">
        <button onClick={() => handleConnexion()} className="connect">
          LOGIN TO SPOTIFY
        </button>
      </div>
    </div>
